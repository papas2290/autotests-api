...
class ExercisesClient(ApiClient):
    ...
    def get_exercises_api(self, query: GetExercisesQuerySchema) -> Response:
        ...
        """
        return self.get(ApiRoutes.EXERCISES, params=query.model_dump(by_alias=True, mode='json'))
    ...
    def create_exercise_api(self, request: CreateExerciseRequestSchema) -> Response:
        ...
        :return: Ответ от сервера в виде httpx.Response
        """
        return self.post(ApiRoutes.EXERCISES, json=request.model_dump(by_alias=True, mode='json'))
    ...
    def update_exercise_api(self, exercise_id: str, request: UpdateExerciseRequestSchema) -> Response:
        ...
        :return: Ответ от сервера в виде httpx.Response
        """
        return self.patch(f'{ApiRoutes.EXERCISES}/{exercise_id}', json=request.model_dump(by_alias=True, mode='json'))
